...
2. Keep the PDFeditorAthome console window open while using the editor.
3. PDFeditorAthome opens http://127.0.0.1:5050 in your default browser.
4. Close the console window when you are finished.
